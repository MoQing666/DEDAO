...
E('shejiao', {
  id: 'dujie_xinmo', title: '一念心魔 · 人劫自现', chapter: true, weight: 6, min: 0, max: 14,
  req: { trib: 1 },
  lines: [
    '修为到了关口，你盘坐入定，识海深处忽然浮起一道影子——',
    '那是被你压了半辈子的旧事：横死的亲人、错过的机缘、那年没送出去的信。',
    '影子逐渐凝成人形，与你一般容貌，眼底却是一片漆黑。它开口，声音与你一模一样：',
    '"连自己的心都不敢看，还谈什么长生？"',
    '人劫如影随形，这一剑，只在你愿不愿意斩。'
  ],
  choices: [
    { t: '直面心魔，斩却执念', special: 'xinmo', resultWin: '你一剑斩落，影子化作轻烟散去，识海复归清明。', resultLose: '心魔反噬，你惊坐而起，冷汗浸透道袍。（人劫未渡）' },
    { t: '强行压下悸动，转身离开', effect: { hp: -30 }, lines: ['你猛地睁眼，压下翻涌的气血。那影子退回识海深处——但你知道，它还在那里。'] }
  ]
});

E('jiyuan', {
  id: 'baishi', title: '仙门开山 · 拜入宗门', chapter: true, weight: 8, min: 5, max: 7, once: true,
  lines: [
    '这一日，青州城外彩霞满天——三座仙门的飞行舟同时降临。',
...
const MONSTER_POOL = {
  lianqi: [
    { name: '青纹狼',     line: '狼眼幽绿，伏低身形，喉咙里压着低吼。' },
    { name: '独眼山魈',   line: '山魈独眼赤红，咧着一嘴烂牙。' },
    { name: '毒雾瘴蟒',   line: '蟒身盘踞，吐出的黑雾带着腥甜。' },
    { name: '双头犬妖',   line: '一火一风两颗头颅，都死死盯着你。' }
  ],
  zhuji: [
    { name: '铁背熊妖',   line: '熊掌拍地，震得土石簌簌而落。' },
    { name: '赤火犀',     line: '犀角燃着黑火，蹄下焦土寸寸开裂。' },
    { name: '幽潭水鬼',   line: '湿漉漉的长发下，是一张惨白的人脸。' },
    { name: '白骨傀',     line: '白骨披着半幅战甲，眼窝里飘着绿火。' }
  ],
  jindan: [
    { name: '千目蛛母',   line: '八足盘踞蛛网中央，千目齐睁。' },
    { name: '噬魂鸦王',   line: '鸦王立于枯树之巅，羽毛间流动着黑光。' },
    { name: '地火龙蜥',   line: '背鳞赤红，一呼一吸间地缝喷火。' },
    { name: '血铠尸将',   line: '血色战甲锈迹斑斑，长戟拖地而行。' }
  ],
  yuanying: [
    { name: '玄冥蛟',     line: '蛟目如灯，盘旋于黑水之上。' },
    { name: '血瞳魔将',   line: '魔将立于血雾之中，甲胄上附着一张张扭曲的人脸。' },
    { name: '九幽魂主',   line: '魂主无声无息，四周草木以肉眼可见的速度枯死。' },
    { name: '天罡石灵',   line: '石林缓缓合拢，它睁开了如山石般的眼皮。' },
    { name: '远古荒鲲',   line: '它只是翻了个身，半个山岳都在震颤。' },
    { name: '堕落真仙',   line: '仙袍褴褛，眼中一片死寂的金光。' }
  ],
  boss: [
    { name: '洞天守门兽', line: '石兽身高三丈，横在洞天入口，双目不怒自威。' },
    { name: '秘境之灵',   line: '它像一团流动的光，又像这座秘境本身。' },
    { name: '藏宝洞主',   line: '须发皆白，腰悬一串钥匙，笑容极为和善——和善得很危险。' }
  ]
};
...
const ADV_NODES = {
  ...
  trap:     { name: '幽暗岔路', icon: '·', desc: '地面传来不祥的窸窣声，像有什么在等着。' },
  rest:     { name: '背风岩缝', icon: '▬', desc: '一处干净避风的地方，适合喘口气。' }
};
