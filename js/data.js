...
const MAINLINE = [
  ...
  { id: 'ml_0_3', idx: 0, title: '村庄危机', chapter: true,
    ...
    resultWin: '你一拳撂倒匪首，余众作鸟兽散。临走那溃兵撂下狠话："独眼龙大哥不会放过你！"——你记下了这个名字。',
...
const MONSTER_POOL = {
  ...
  huang: [
    { name: '赤狼旗喽罗', line: '独眼龙手下的小卒，打着赤狼旗，正是洗劫村庄的那伙人。' },
  ...
  boss: [
    { name: '匪首', line: '独眼龙，左眼一道刀疤。当年洗劫村庄的赤狼旗，正是他手下——今日新仇旧账一起算。' },
...
const ADVENTURE_CONFIG = {
  huang: {
    ...
    grade: '黄',
    realmReq: 0,
    desc: '炼气期秘境。当年洗劫村庄的赤狼旗匪帮盘踞于此，寨主独眼龙，正是那日扬言寻仇之人。',
