  ...
  var STAGES = {
    title: [
      { target: 't-new', title: '开始轮回',
        body: '从零开启一局新游戏。点它会进入【天命抉择】开荒页：先选起始境界，再抽取灵根与命格，最后点「开始这一世」正式踏入凡尘。每一世都是新的开始——先点它，正式启程。' },
      { target: 't-rebirth', title: '轮回阁 · 天赋',
        body: '这里消耗通关积累的【轮回点】解锁永久天赋，下一世开局即生效——这是「放置 / 轮回」养成的核心。但别急，先去这一世历练一番，回头再来点天赋也不迟。' }
    ],
    basics: [
      { target: 'btn-cult', title: '修炼',
        body: '消耗行动点闭关吐纳，增长修为。修为攒满后，右侧【突破】会亮起，点它破境提升境界——境界越高，实力越强。' },
      { target: 'btn-char-bottom', goto: 'char', title: '角色',
        body: '点底部【角色】查看六维、灵根与实时战斗属性，还能装备法宝功法。修行路上随时回来对照自己的成长。' },
      { target: 'btn-social', title: '游历',
        body: '展开山河图四处游历，触发机缘事件与仙缘人物，是剧情与特殊奖励的主要来源。' },
      { target: null, noSpot: true, title: '下一步怎么走',
    ...
    sect: [
      { target: 'btn-sect', goto: 'sect', title: '宗门 · 第 5 年接触',
        body: '第 5 年，是时候接触宗门了。点这里接取宗门任务换取资源与声望；拜入宗门后还会开启【百艺】。' },
